...
const PERM_CATALOG = [
  ...
  { key: 'action.add_category', group: 'Categorias', label: 'Adicionar categoria de custo' },
  { key: 'action.edit_category', group: 'Categorias', label: 'Editar categoria de custo' },
  { key: 'action.delete_category', group: 'Categorias', label: 'Excluir categoria de custo' },
...
const DEFAULTS_FINANCEIRO = {
  ...
  'action.add_category': 1,
  'action.edit_category': 1,
  'action.delete_category': 1,
  'view.kpi_caixa': 0,
  'view.runway': 0,
  'view.audit_log': 0,
